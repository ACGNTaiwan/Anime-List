...
Anime = [
    ...
    ['RWBY Volume 1-3: The Beginning', 'Fri', '2017年7月7日（五）25：05', 'Original', 'RWBY Volume 1-3: The Beginning', '圖片', '本作的背景設定在同時具有高科技和超自然力量的世界。此世界有四個「王國」以及在王國外的聚落、兩個智慧人種（人類和獸人 Faunus）、以及稱為魔獸（Grimm）的怪獸；大部份的科技是用稱為塵晶Dust的物質運作，這是人們得以對抗魔獸的力量來源之一。'],
    ...
    ['KAITO X ANSA', 'Wed', '2017年7月12日（三）20：10', '改編', 'カイトアンサ', 'https://i.imgur.com/KKAcKu2.jpg', '距離立川消滅還有5小時。被選中為救世主「Q Former」，深愛立川的熱血男人阿園魁斗及其好友有進杏茶，背負起了解放閃耀的能量結晶「Q Stone」，拯救立川消滅的危機的使命。與前輩Q Former網野解音以及元氣JK寶川日向一起，向敵人的使者16臣封所出的16道「解謎」發起挑戰的兩人。他們究竟能否答對全部的問題！？拯救立川！拜託了！魁斗、杏茶！'],
    ...
    ['咕嚕咕嚕魔法陣', 'Tue', '2017年7月11日（二）1：35', '改編', '魔法陣グルグル 新シリーズ', 'https://i.imgur.com/EzdEXDd.jpg', '故事內容為，300年前被封印的魔王吉利再次復活，主角尼克和柯柯麗須合力再次把吉利封印。沿途上二人路經不同的村落，接觸不同的人，並透過修行提升等級。'],
    ['ROBO MASTERS THE ANIMATED SERIES', 'Mon', '2017年7月（）', '改編', 'ROBO MASTERS THE ANIMATED SERIES', 'https://i.imgur.com/RNxjvqj.jpg', '大學的新學期伊始。心無雜念頭腦裡只想著如何改良自己做的無人機，KAKA的單單在熱鬧非凡的各大社團招新人海中，略顯得有些格格不入。在單單從校舍後方的廣場向延綿海岸扔出飛碟，進行無人機KAKA的捕捉測試時因為海風的影響飛碟不小心飛到了一名女生的身上。 ，這突如其來的事故，卻變為了使原本有些自閉的單單逐漸成長的契機。'],
    ...
    ['雛邏輯～from Luck & Logic～', 'Sat', '2017年7月1日（六）22：30', '改編', 'ひなろじ～from Luck & Logic～', 'https://i.imgur.com/CR6H2y7.jpg', '在L.C.922年，人們正在面對空前的危機。在神話世界的百年戰爭結束後，在神話世界中戰敗的魔神為了在地上尋求新的安居之所，開始向人類世界襲來。背負著守護街區宿命的警察特殊機關阿爾卡（ALCA），旗下年輕的盟約者被強制與擁有特殊能力的異世界女神合體，並進而投身戰場之中。'],
