...
var Anime = (Anime = [ {
    ...
    return new Date(2018, a.date.split("/")[0], a.date.split("/")[1], a.time.split(":")[0], a.time.split(":")[1]) - new Date(2018, i.date.split("/")[0], i.date.split("/")[1], i.time.split(":")[0], i.time.split(":")[1]);
});
